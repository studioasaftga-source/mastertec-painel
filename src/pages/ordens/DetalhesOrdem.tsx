...
export default function DetalhesOrdem() {
  ...
  // O.S. só é realmente encerrada quando chega a
   ...
   * IMPORTANTE:
   *
   * O total normal da O.S. NÃO usa mais o valor_total antigo
   * da tabela ordens_servico.
   *
   * A fonte principal passa a ser a soma das tarefas atuais.
   *
   * Isso evita o problema em que o funcionário altera a O.S.
   * pelo PWA, as linhas ficam corretas, mas o total antigo
   * continua aparecendo no painel.
   */
  ...
  /*
   * Calcula novamente os subtotais de serviços, peças
   * e total geral com base nas tarefas.
   */
  const calcularTotaisTarefas = useCallback(
    (lista: Tarefa[]) => {
      return lista.reduce(
        (totais, tarefa) => {
          const total =
    ...
    useCallback(
      async (
        ...
        const {
          ...
          .from('usuarios')
          .select(
            'id,nome,codigo_acesso,empresa_id,ativo',
          )
          .eq(
            'id',
            responsavelId,
    ...
    useCallback(
      async (
        ...
        try {
           ...
           * CORREÇÃO PRINCIPAL:
           *
           * Quando o funcionário altera uma O.S. pelo PWA,
           * as tarefas podem estar novas/corretas enquanto
           * ordens_servico.valor_total ainda guarda o valor
           * antigo.
           *
           * Aqui calculamos o valor verdadeiro diretamente
           * das tarefas e sincronizamos o cabeçalho da O.S.
           * no banco.
           */
          if (
            ...
            if (
              ...
              if (
                ...
                console.warn(
                  'Não foi possível sincronizar os totais da O.S.:',
                  erroSincronizacao,
                )
              } else {
                /*
                 * Também atualiza a cópia local para a tela
                 * mostrar imediatamente o novo valor.
                 */
                setOrdem(
                  atual =>
                    atual
  ...
  async function salvarEdicao() {
    ...
    try {
      ...
      if (
        ...
        throw new Error(
          'Esta O.S. está cancelada e não pode ser alterada.',
        )
      }
  ...
  async function atribuirTecnico() {
    ...
    if (osEncerrada) {
      setErro(
        'A O.S. está encerrada. Não é possível alterar o técnico.',
      )
  ...
  async function encerrarOS() {
    ...
    try {
      ...
      /*
       * O encerramento também calcula o total diretamente
       * das tarefas atuais.
       */
      const totais =
        calcularTotaisTarefas(
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                {aguardandoPainel
                  ? 'FUNCIONÁRIO ENVIOU PARA O PAINEL'
                  : osEncerrada
            ...
            {!modoEdicao ? (
              ...
              >
                ...
                >
                  ...
                  valor unitário, excluir
                  linhas ou adicionar novas.
                </div>
              </div>
            )}
              ...
              >
                ...
                >
                  ...
                  <div>
                    ...
                    >
                      O PWA do funcionário
                      está em modo somente
                      visualização.
                    </div>
                  </div>
                </div>
...
const cabecalhoTabela: CSSProperties = {
  display:
    'grid',
  gridTemplateColumns:
    '42px minmax(0,1fr) 80px 130px 130px',
  gap:
    10,
  alignItems:
    'center',
...
const cabecalhoTabelaEdicao: CSSProperties = {
  display:
    'grid',
  gridTemplateColumns:
    'minmax(0,1fr) 80px 130px 110px 42px',
  gap:
    8,
  padding:
    '0 10px 6px',
